...
# Show the prompt at the top with inline info, place a border around
# FZF and take up only 35 percent of the screen height, and set the
# colors to match the terminal theme
export FZF_DEFAULT_OPTS="
  --reverse \
  --height=50% \
  --style minimal \
  --border sharp \
  --color=bg+:11,bg:0,border:8,spinner:7,hl:8,\
