...
for plugin, configuration in pairs({
  ...
  Shoji = {
    ...
    hotkeys = {
      ...
      increase_main_count = { { "cmd", "alt", "shift" }, "i" },
      decrease_main_count = { { "cmd", "alt", "shift" }, "d" },
      reset_space = { { "ctrl", "alt", "shift" }, "0" },
      reset_window_order = {},
      toggle_float = { { "ctrl", "alt", "shift" }, "t" },
      toggle_zoom = { { "ctrl", "alt" }, "q" },
      retile_space = { { "cmd", "alt" }, "r" },
      send_to_next_region = { { "cmd", "ctrl", "alt" }, "[" },
      send_to_prev_region = { { "cmd", "ctrl", "alt" }, "]" },
      balance_regions = { { "cmd", "ctrl", "alt" }, "b" },
